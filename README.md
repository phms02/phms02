...
➜ Knowledges:
   <ul>
     <li>Technologies: HTML, CSS, Bootstrap, JavaScript, TypeScript, React.js, Python, PHP, MySQL;</li>
...
➜ Conhecimentos:
   <ul>
     <li>Tecnologias: HTML, CSS, Bootstrap, JavaScript, TypeScript, React.js, Python, PHP, MySQL;</li>
