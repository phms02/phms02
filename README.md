...
➜ Knowledges:
   <ul>
     <li>Technologies: HTML, CSS, Bootstrap, JavaScript, React.js, React Native, Python, PHP, MySQL;</li>
...
➜ Conhecimentos:
   <ul>
     <li>Tecnologias: HTML, CSS, Bootstrap, JavaScript, React.js, React Native, Python, PHP, MySQL;</li>
